...
if(isset($_POST['row_hocky'])) {
	if(isset($_POST['row_id'])) $n=(int)$_POST['row_id'];
 	$_SESSION["SV$ma"]['TAB_KYLUAT'][$n]['hocky']= addslashes(strip_tags($_POST['row_hocky']));
 	$_SESSION["SV$ma"]['TAB_KYLUAT'][$n]['hinhthuc']= addslashes(strip_tags($_POST['row_hthuc']));
 	$_SESSION["SV$ma"]['TAB_KYLUAT'][$n]['lydo']= addslashes(strip_tags($_POST['row_lydo']));
 	$_SESSION["SV$ma"]['TAB_KYLUAT'][$n]['quyetdinh']= addslashes(strip_tags($_POST['row_qdinh']));
 	$_SESSION["SV$ma"]['TAB_KYLUAT'][$n]['tungay']= addslashes(strip_tags($_POST['row_tungay']));
 	$_SESSION["SV$ma"]['TAB_KYLUAT'][$n]['denngay']= addslashes(strip_tags($_POST['row_denngay']));
}?>
