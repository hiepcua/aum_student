...
if($ids!=='') {
	...
	$result = SysEdit('tbl_dangky_tuyensinh', array('tinhtrang_call'=> $status_call, 'last_contact'=> $last_contact), "id IN ('".$ids."')");

	if($note==""){
		$note = "Cập nhật tình trạng cuộc gọi: (".$txt_tinhtrang_call_new.")";
	}
