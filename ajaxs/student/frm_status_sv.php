...
$status_sv = isset($_POST['status_sv']) ? antiData($_POST['status_sv']) : '';
...
<form id="frm_status" method="post">
	...
	<div class="form-group">
		<label>Tình trạng học viên</label>
		<select name="cbo_status_sv" id="cbo_status_sv" class="form-control required" required>
			<?php
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#btnsave").click(function(){	
			if(validForm()==true) {
				showLoading();
				var url = "<?php echo ROOTHOST;?>ajaxs/student/process_status_sv.php";
				$.ajax({
					type: "POST",
					url: url,
