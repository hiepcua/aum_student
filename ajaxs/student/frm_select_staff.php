...
$id_staff = isset($_POST['id_staff']) ? antiData($_POST['id_staff']) : '';
...
if(array_key_exists($_SESSION[MD5($_SERVER['HTTP_HOST']).'_MEMBER_LOGIN']['uid'], $STAFF_NV)){
	$IS_NV = true;
}else{
	$IS_NV = false;
}
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#btnsave").click(function(){	
			if(validForm()==true) {
				showLoading();
				var url = "<?php echo ROOTHOST;?>ajaxs/student/process_select_staff.php";
				$.ajax({
					type: "POST",
					url: url,
