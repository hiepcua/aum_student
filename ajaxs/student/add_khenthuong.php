...
<table class="table table-striped">
	...
	<tr class="new"><td></td><td><?php echo $stt+1;?></td>
		<td><input type="number" name="row_hocky" class="form-control" placeholder="Học kỳ"></td>
		<td><input type="text" name="row_hthuc" class="form-control" placeholder="Hình thức"></td>
		<td><input type="text" name="row_lydo" class="form-control" placeholder="Lý do"></td>
		<td><input type="text" name="row_qdinh" class="form-control" placeholder="Quyết định"></td>
		<td><input type="text" name="row_ghichu" class="form-control" placeholder="Ghi chú"></td>
		<td><button type="button" class="btn btn-success" id="save_khenthuong"><i class="fa fa-save"></i></button></td>
	</tr>
	</tbody>
</table>
<script>
