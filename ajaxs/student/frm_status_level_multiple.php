...
<form id="frm_status" method="post">
	...
	<div class="form-group">
		<label>Level học viên:</label>
		<select name="cbo_status_level" id="cbo_status_level" class="form-control required" required>
			<?php
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#btnsave").click(function(){	
			if(validForm()==true) {
				showLoading();
				var url = "<?php echo ROOTHOST;?>ajaxs/student/process_status_level_multiple.php";
				$.ajax({
					type: "POST",
					url: url,
