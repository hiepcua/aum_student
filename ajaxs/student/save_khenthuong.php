...
if(isset($_POST['row_hocky'])) {
	if(isset($_POST['row_id'])) $n=(int)$_POST['row_id'];
 	$_SESSION["SV$ma"]['TAB_KHENTHUONG'][$n]['hocky']= addslashes(strip_tags($_POST['row_hocky']));
 	$_SESSION["SV$ma"]['TAB_KHENTHUONG'][$n]['hinhthuc']= addslashes(strip_tags($_POST['row_hthuc']));
 	$_SESSION["SV$ma"]['TAB_KHENTHUONG'][$n]['lydo']= addslashes(strip_tags($_POST['row_lydo']));
 	$_SESSION["SV$ma"]['TAB_KHENTHUONG'][$n]['quyetdinh']= addslashes(strip_tags($_POST['row_qdinh']));
 	$_SESSION["SV$ma"]['TAB_KHENTHUONG'][$n]['ghichu']= addslashes(strip_tags($_POST['row_ghichu']));
}?>
