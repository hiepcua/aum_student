...
<table class="table table-striped">
	...
	<tr class="new"><td></td><td><?php echo $stt+1;?></td>
		<td><input type="date" name="row_time" class="form-control" placeholder="Thời gian"></td>
		<td><input type="text" name="row_noidung" class="form-control" placeholder="Nội dung"></td>
		<td><input type="text" name="row_lop" class="form-control" placeholder="Lớp"></td>
		<td><button type="button" class="btn btn-success" id="save_qthoc"><i class="fa fa-save"></i></button></td>
	</tr>
	</tbody>
</table>
<script>
$("#save_qthoc").click(function(){
	...
	$.post(url,{'ma':ma,'row_time':row_time,'row_noidung':row_noidung,'row_lop':row_lop},function(req){
		console.log(req);
		$("#tab3").html(req);
	})
})
