...
$sql="SELECT * FROM tbl_hocphan_khung WHERE id='$id_daotao'";
$obj=new CLS_MYSQL;
$obj->Query($sql);
...
<input type='hidden' id='txtid' value='<?php echo $id_daotao;?>'/>
<div class="row form-group">
...
$(document).ready(function(){
	...
	$("#btnsave").click(function(){
		...
		var url = "ajaxs/khungdaotao/process_edit.php";
		if(check_input()==true) {
			$.post(url,{'id':id,'monhoc':monhoc,'nganh':nganh,'he':he,'hocky':hocky,'tinchi':tinchi,'chuyencan':chuyencan,'kiemtra':kiemtra,'thi':thi,'tong':tong},function(req){
				console.log(req);
