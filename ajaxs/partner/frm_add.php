...
<div class="row form-group">
	...
	<div class="col-md-6 col-xs-8">
		<input type="text" name="txtdiachi" id="txtdiachi" value='' class="form-control" required>
	</div>
</div>
<div class="row form-group">
...
$(document).ready(function(){
	$("#btnsave").click(function(){
		...
		var url = "ajaxs/partner/process_add.php";
		if(name!=''){
			$.post(url,{'name':name,'diachi':diachi,'phone':phone},function(req){
				console.log(req);
				if(req=="E01") showMess("Vui lòng đăng nhập hệ thống","error");
				else if(req=="success"){
					showMess("Thêm đối tác thành công");
