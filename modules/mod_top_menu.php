					...
					<li>
						<div class="btn-group form-profile">
							<div class="pull-left action dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
								<a href="javascript:void(0);" id="nav_registry" ><span class='avatar-small'><i class="fa fa-user fa-2" aria-hidden="true"></i></span> <?php echo getInfo('lastname').' '.getInfo('firstname');?> </a><i class="fa fa-caret-down" aria-hidden="true"></i>
							</div>
	...
	<div class="main-menu container-fluid">
		<div class='topmenu'>
			<ul class="nav navbar-nav">
				...
				<li>
					<a href='<?php echo ROOTHOST;?>?com=edu&task=khungdaotao'>
						<i class="fa fa-file-text-o"></i> Khung đào tạo
					</a>
				</li>
				<li>
					<a href="javascript:void(0);"><i class="fa fa-file-text-o" aria-hidden="true"></i> Quản lý đào tạo</a>
					<ul class="submenu">
						<li>
