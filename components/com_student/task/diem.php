...
$sql = "SELECT a.*,b.ho_dem,b.name,b.gioitinh,b.ngaysinh,
		k.name AS ten_khoa,n.name AS ten_nganh,h.name AS ten_he 
		FROM tbl_dangky_tuyensinh AS a 
		INNER JOIN tbl_hocsinh AS b ON a.id_hoso=b.ma
		INNER JOIN tbl_he AS h ON a.id_he=h.id
		INNER JOIN tbl_nganh AS n ON a.id_nganh=n.id
		INNER JOIN tbl_khoa AS k ON a.id_khoa=k.id
		WHERE a.id_hoso='$ma'";
$obj->Query($sql);
...
$masv = $r_ts['masv'];
$ten_khoa = $r_ts['ten_khoa'];
$ten_nganh = $r_ts['ten_nganh'];
$ten_he = $r_ts['ten_he'];
	...
	<div class="page-bar">
		<div class="page-title-breadcrumb">
			...
			<ul class="box-function pull-right">
				<li><button type="button" class="btn btn-warning btn-print"  title="In bảng điểm">
					<i class="fa fa-print"></i> In</button></li>
				<li><a href="<?php echo ROOTHOST;?>student" class="btn btn-default btn-close" title="Thoát">
