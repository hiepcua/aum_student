<?php $tk_nganh=$ten=$cmt=$ns=$dc=$sbd=$diem='';
...
<div class="search_box panel panel-warning"><div class="panel-body"><div class="media row">
	...
	<div class="form-group">
		...
		<div class="col-md-2">
			<input type="text" name="tk_diem" id="tk_diem" value="<?php echo $diem;?>" placeholder="Điểm sàn" class="form-control"/>
		</div>
	</div>
...
function SubmitSearch() {
	...
	/* var url = "<?php echo ROOTHOST;?>ajaxs/tuyensinh/list_hsdathi.php";
	$.post(url,{'ten':_ten,'cmt':_cmt,'ns':_ns,'dc':_dc,'nganh':_nganh,'sbd':_sbd,'diem':_diem},function(req){
