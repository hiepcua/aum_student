...
<div class='body profile_view'>
	...
	<div class="card">
		<div class="card-body"><div class="card-block"><div class="media">
			<div class="row"><form name="student_add" id="student_add" class="form" action="#" method="post" enctype='multipart/form-data'>
				...
				<div class="col-md-9 col-xs-12">
					<div class="row form-group">
						...
						<div class="col-md-4 col-xs-8">
							<input type="number" name="masv" id="masv" class="form-control" value="" required>
						</div>
	...
	$(".box-function .btn-save").click(function(){
		...
		if(checkinput()==true) {
			...
			$.ajax({
			   type: "POST",
			   url: url,
			   data: $("#student_add").serialize(), // serializes the form's elements.
