	...
	<div class="page-bar">
		<div class="page-title-breadcrumb">
			...
			<ul class="box-function pull-right">
				...
				<li><a href="<?php echo ROOTHOST.'student/profile/'.$ma;?>" class="btn btn-default btn-close" title="Quay lại">
					<i class="fa fa-reply"></i> Quay lại</a></li>
			</ul>
		</div>
	</div>
	<div class="card">
		<div class="card-body"><div class="card-block"><div class="media">
			<div class="row"><form name="student_edit" id="student_edit" class="form" action="#" method="post" enctype='multipart/form-data'>
				...
				<div class="box-tabs box-add">
					<ul class="tabs-function">
						<li><button type="button" class="btn btn-default add-row" title="Thêm hàng">
							<i class="fa fa-folder-open"></i></button></li>
						<li><button type="button" class="btn btn-default delete-row red" title="Xóa hàng">
					...
					<div class="tab-content">
						...
						<div class="tab-pane fade in" id="tab6">
							<table class="table table-striped">
								...
								<?php $i++;} // end foreach
								} elseif($id_he==null) echo '<tr><td colspan="4">Vui lòng đăng ký khóa, bậc, ngành đào tạo trước khi thêm danh mục hồ sơ</td></tr>';
								else { 
								$obj=new CLS_MYSQL;
	...
	$(".box-function .btn-save").click(function(){
		...
		if(checkinput()==true) {
			...
			$.ajax({
			   type: "POST",
			   url: url,
			   data: $("#student_edit").serialize(), // serializes the form's elements.
