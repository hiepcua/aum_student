...
$obj = new CLS_MYSQL;
$sql = "select a.id,b.partner_id,c.name as partner_name,count(b.partner_id) as num 
...
$sql.=" group by b.partner_id order by num DESC";
...
<div class='body profile_view'>
	<div class="page-bar">
		<div class="page-title-breadcrumb">
			<div class="pull-left">
				<div class="page-title">Thống kê Hồ sơ theo đối tác</div>
			</div><?php /*
	...
	<table class="list table table-striped table-bordered">
		<thead><tr class="header">
			...
			<th>Đối tác</th><th>Tổng hồ sơ</th>
			<th>Ngành</th>
			<th>Xem danh sách</th>
		</tr></thead>
		<tbody>
		...
		$total+=$r['num'];
		$objts = new CLS_TUYENSINH; $partner_id = $r['partner_id'];
		$str = $objts->NumberNganhByPartner($partner_id,$id_khoa,$id_he);?>
		<tr><td align="center"><?php echo $i;?></td>
		
		<td><?php echo stripslashes($r['partner_name']);?></td>
		<td class="text-center cred"><b><?php echo number_format($r['num']);?></b></td>
		<td><?php echo $str;?></td>
		<td class="text-center">
			<a href="<?php echo ROOTHOST;?>report/hoso/tonghop?khoa=<?php echo $id_khoa;?>&bac=<?php echo $id_he;?>&partner=<?php echo $partner_id;?>" class="btn btn-default"><i class="fa fa-list"></i></a>
		</td>
		</tr><?php $i++;} ?>
